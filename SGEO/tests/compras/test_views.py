...
from SGEO.tests.test_case import BaseTestCase, replace_none_values_in_dictionary
from SGEO.apps.cadastro.models import Fornecedor, Produto
from SGEO.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from SGEO.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
