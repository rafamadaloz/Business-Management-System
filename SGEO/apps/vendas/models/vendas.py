...
MOD_FRETE_ESCOLHAS = (
    (u'0', u'Por conta do remetente'),
    (u'1', u'Por conta do destinatário'),
    (u'2', u'Por conta de terceiros'),
    (u'3', u'Transporte próprio do remetente'),
    (u'4', u'Transporte próprio do destinatário'),
    (u'9', u'Sem frete'),
)
...
class Venda(models.Model):
    ...
    peso_bruto = models.DecimalField(max_digits=16, decimal_places=3, validators=[
        MinValueValidator(Decimal('0.000'))], default=Decimal('0.000'))

    peso_liquido = models.DecimalField(max_digits=16, decimal_places=3, validators=[
        MinValueValidator(Decimal('0.000'))], default=Decimal('0.000'))

    volumes = models.PositiveIntegerField(default=0)

    especie_transporte = models.CharField(max_length=60, null=True, blank=True)

    marca_transporte = models.CharField(max_length=60, null=True, blank=True)
