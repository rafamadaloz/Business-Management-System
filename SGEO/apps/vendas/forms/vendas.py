...
from SGEO.apps.vendas.models import OrcamentoVenda, PedidoVenda, ItensVenda, Venda
...
class VendaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'peso_liquido': forms.TextInput(attrs={'class': 'form-control'}),
            'peso_bruto': forms.TextInput(attrs={'class': 'form-control'}),
        }
        labels = {
