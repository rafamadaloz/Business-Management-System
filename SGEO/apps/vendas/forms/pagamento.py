...
from SGEO.apps.vendas.models import Venda, Pagamento, CondicaoPagamento
...
class CondicaoPagamentoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('descricao', 'forma', 'n_parcelas',
                  'dias_recorrencia', 'parcela_inicial', 'dia_pagamento', 'flag_dia_pagamento')
        widgets = {
            ...
            'flag_dia_pagamento': forms.CheckboxInput(attrs={'class': 'form-control'}),
        }
        labels = {
            ...
            'flag_dia_pagamento': 'Escolher dia de pagamento'
        }
