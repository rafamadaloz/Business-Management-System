...
from SGEO.configs.settings import MEDIA_ROOT, APP_ROOT
...
class NotaFiscal(models.Model):
    arquivo = models.FileField(
        upload_to='arquivos/notasfiscais/', null=True, blank=True)
    chave = models.CharField(max_length=44)
    versao = models.CharField(max_length=4, choices=VERSOES, default='4.0')
    natop = models.ForeignKey('fiscal.NaturezaOperacao', related_name="nat_op",
