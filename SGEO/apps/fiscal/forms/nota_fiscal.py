...
from SGEO.apps.fiscal.models import NotaFiscalSaida, NotaFiscalEntrada, AutXML, ConfiguracaoNotaFiscal, TP_AMB_ESCOLHAS, MOD_NFE_ESCOLHAS
from SGEO.apps.cadastro.models import Empresa
...
class NotaFiscalForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'natop': forms.Select(attrs={'class': 'form-control'}),
