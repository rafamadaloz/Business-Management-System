...
urlpatterns = [
    ...
    url(r'^plano/configuracoes/$', views.ConfiguracoesPlanoView.as_view(), name='configuracoesplanoview'),

    url(r'^infoNotaAdicional/$', views.InfoNotaAdicional.as_view(), name='infoNotaAdiconal'),
