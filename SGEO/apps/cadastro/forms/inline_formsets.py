...
from SGEO.apps.cadastro.models import Pessoa, Endereco, Telefone, Email, Site, Banco, Documento, Lote, Produto
...
class LoteForm(forms.ModelForm):
    ...
    class Meta:
        model = Lote
        fields = ('codigo', 'validade', 'quantidade')
        labels = {
            'codigo': 'Código',
...
LoteFormSet = inlineformset_factory(
    Produto, Lote, form=LoteForm, extra=1, can_delete=True)
