...
from SGEO.apps.financeiro.forms import PlanoContasGrupoForm, PlanoContasSubgrupoFormSet, CentroCustoForm
...
class EditarCentroCustoView(CustomUpdateView):
    ...
    form_class = CentroCustoForm
    model = CentroCusto
    success_url = reverse_lazy('financeiro:centrocustosview')
